...
func (c *layeredGlobalIPCache) Get(ctx context.Context, key any, returnObj any) (any, error) {
...
func (c *layeredGlobalIPCache) Set(ctx context.Context, key, object any, options ...store.Option) error {
	keyString, ok := key.(string)
	if !ok {
...
func unmarshalGlobalIPValue(value any, returnObj any) (any, error) {
	data, err := globalIPValueBytes(value)
	if err != nil {
		return nil, err
	}
...
func globalIPValueBytes(value any) ([]byte, error) {
